            ...
            <div class="footer-wrapper">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "EDIT_TEMPLATE" => "",
                        "PATH" => SITE_TEMPLATE_PATH . "/includes/footer_logo_inc.php"
                    )
                );?>
                <div class="footer__feedback">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => SITE_TEMPLATE_PATH . "/includes/footer_email_inc.php"
                        )
                    );?>
                    ...
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => SITE_TEMPLATE_PATH . "/includes/footer_phone_inc.php"
                        )
                    );?>
                </div>
                <div class="footer__law">
                    YANICODE <?echo date('Y'); ?> © ВСЕ ПРАВА ЗАЩИЩЕНЫ.
